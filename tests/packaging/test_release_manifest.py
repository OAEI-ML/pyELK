...
_MATRIX = {
    "pyelk_reasoner-0.2.0.tar.gz": ("sdist", ()),
    "pyelk_reasoner-0.2.0-py3-none-any.whl": ("pure-wheel", ("py3-none-any",)),
    "pyelk_reasoner-0.2.0-cp310-abi3-manylinux_2_17_x86_64.manylinux2014_x86_64.whl": (
        "native-wheel",
        (
    ...
    "pyelk_reasoner-0.2.0-cp310-abi3-manylinux_2_17_aarch64.manylinux2014_aarch64.whl": (
        "native-wheel",
        (
    ...
    "pyelk_reasoner-0.2.0-cp310-abi3-musllinux_1_2_x86_64.whl": (
        "native-wheel",
        ("cp310-abi3-musllinux_1_2_x86_64",),
    ),
    "pyelk_reasoner-0.2.0-cp310-abi3-musllinux_1_2_aarch64.whl": (
        "native-wheel",
        ("cp310-abi3-musllinux_1_2_aarch64",),
    ),
    "pyelk_reasoner-0.2.0-cp310-abi3-macosx_10_12_x86_64.whl": (
        "native-wheel",
        ("cp310-abi3-macosx_10_12_x86_64",),
    ),
    "pyelk_reasoner-0.2.0-cp310-abi3-macosx_11_0_arm64.whl": (
        "native-wheel",
        ("cp310-abi3-macosx_11_0_arm64",),
    ),
    "pyelk_reasoner-0.2.0-cp310-abi3-win_amd64.whl": (
        "native-wheel",
...
def test_matrix_rejects_a_non_tier_one_native_substitution(
    ...
    artifacts = _artifacts(tmp_path)
    windows = artifacts / "pyelk_reasoner-0.2.0-cp310-abi3-win_amd64.whl"
    arm = artifacts / "pyelk_reasoner-0.2.0-cp310-abi3-win_arm64.whl"
    windows.rename(arm)
...
def test_binding_rejects_an_artifact_changed_during_inspection(
    ...
    wheel = tmp_path / "pyelk_reasoner-0.2.0-py3-none-any.whl"
...
def test_verification_rejects_artifact_tampering_and_self_sweeping(
    ...
    pure = artifacts / "pyelk_reasoner-0.2.0-py3-none-any.whl"
